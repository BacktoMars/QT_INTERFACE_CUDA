...
//extern "C" void launch_Mandelbrot_kernel(uchar4*, unsigned int, unsigned int);
extern "C" void launch_Mandelbrot_kernel(uchar4*, unsigned int, unsigned int, float, float, float ,float);
